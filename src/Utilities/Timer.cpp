...
//-------------------------------------------------------------------------------------------------------
Timer::Timer(const char *func_name, TimerControl *timerControl) : m_FuncName(func_name), m_Stopped(false),
                                                                  m_TimerControlPtr(timerControl) {
...
void Timer::Stop() {
    ...
    m_TimerControlPtr->WriteProfile(m_FuncName, start, end, threadID);
